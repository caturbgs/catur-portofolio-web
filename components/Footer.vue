  ...
  <footer class="h-[--header-height-mobile] sm:h-[--header-height] text-sm font-mono w-full">
    <div class="container px-3 sm:px-8 md:max-w-screen-md h-full flex justify-between items-center">
      <HoverCard :open-delay="0">
        <HoverCardTrigger>
          <p class="hover:cursor-pointer text-gray-500">Catur Bagaskara</p>
        </HoverCardTrigger>
        <HoverCardContent class="w-full p-2 font-mono">
          <div class="flex flex-col gap-2">
            ...
            <Button
              ...
              class="justify-start gap-3 text-sm font-medium transition-colors hover:text-primary hover:bg-accent/10"
            >
              <NuxtLink to="https://linkedin.com/in/caturbagas" target="_blank">
                <Linkedin class="mr-2 size-4" />
                <p>caturbagas</p>
              </NuxtLink>
            </Button>
            <Button
      ...
      <NuxtLink to="https://github.com/caturbgs/catur-portofolio-web" target="_blank">
        <p class="border-b border-gray-300 dark:border-gray-500 hover:border-gray-600 dark:hover:border-white">
          Source
        </p>
      </NuxtLink>
    </div>
