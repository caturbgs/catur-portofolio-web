        ...
        <TooltipProvider :delay-duration="0" disable-closing-trigger>
            <Tooltip>
                <TooltipTrigger as-child>
                    <Button variant="outline" size="icon" class="hover:bg-accent/10 bg-transparent border-0 group"
                ...
                <TooltipContent>
                    <p class="font-mono text-sm sm:text-base">Switch to {{ state === 'auto' ? 'Light Mode' : state ===
                        'dark' ? 'System Preference' : 'Dark Mode' }}</p>
                </TooltipContent>
            </Tooltip>
        </TooltipProvider>
    </nav>
